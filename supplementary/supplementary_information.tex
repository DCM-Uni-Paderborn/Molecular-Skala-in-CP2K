...
The data package accompanying the manuscript contains the molecular structures, \CPtwoK{} inputs, selected raw outputs, processed tables, and short extraction scripts needed to reproduce the numerical tables in the manuscript.  The final archive also contains checksums and machine-readable metadata.  Diagnostic development files that are not required for reproducing the published tables are kept out of the Supplementary Information and, where retained for provenance, are clearly separated in the data package.
